                ...
                .andDo(document("get-answers",
                        ...
                        responseFields(
                                List.of(
                                        ...
                                        fieldWithPath("data[].memberJpegUrl").type(JsonFieldType.STRING).description("Jpeg 주소"),
                                        fieldWithPath("data[].memberPngUrl").type(JsonFieldType.STRING).description("Png 주소"),
                                        ...
                                        fieldWithPath("data[].answerAnswers[].memberJpegUrl").type(JsonFieldType.STRING).description("Jpeg 주소"),
                                        fieldWithPath("data[].answerAnswers[].memberPngUrl").type(JsonFieldType.STRING).description("Png 주소"),
